...
async function req(path, options = {}) {
  ...
  // DELETE returns {"status":"removed"}, others return JSON
...
// Users
export const searchUsers = (q, me) =>
  req(`/users/search?q=${encodeURIComponent(q)}&me=${me}`);
...
export const removeFriend       = (friendId, me)  => req(`/friends/${friendId}?me=${me}`,          { method: "DELETE" });
